...
angular.module('ApiAdmin').controller('WebsitesController', ['$scope', '$Config', '$resource', '$location', '$compile', '$mdDialog', '$Theme', '$IDE', function ($scope, $Config,$resource, $location, $compile, $mdDialog, $Theme, $IDE) {
    ...
    $scope.New = function () {
            ...
            var itemUrl = 'modules/delgado/website.html';
            var item = { itemKey: "b_" + _id + "", name: "new website" };
            $IDE.ShowLobby(item, itemUrl);
            return false;
