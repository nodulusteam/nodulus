...
angular.module('ApiAdmin').controller('WebsiteController', ['$scope', '$Config', '$resource', '$location', '$compile', '$mdDialog', '$Theme', '$IDE', function ($scope, $Config, $resource, $location, $compile, $mdDialog, $Theme,$IDE) {
