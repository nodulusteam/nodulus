DynamicData.
controller("LobbyController", function ($scope, $resource, $Cache, $uibModal) {
    var dbApi = "";
...
//dbapi.get()
    ...
    $scope.showDetails = function (rowItem, e) {
        ...
        var item = { itemKey: $scope.schemaid + "_" + _id + "", name: itemName, schemaid: $scope.schemaid };
    ...
    $scope.CreateNewItem = function () {
        ...
        $scope.$parent.$parent.$parent.ShowLobby(item, itemUrl);
    }
