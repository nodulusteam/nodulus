...
angular.module("schemaForm").run(["$templateCache", function ($templateCache) {
        ...
        $templateCache.put("decorators/bootstrap/table.html", "<div class='col-lg-12 col-md-12'>" +              
            ...
            "<tbody ng-hide='collapsed'><tr ng-repeat='row in gridOptions.rowData' ng-dblclick=\"edit(row,form)\"><td ng-repeat='column in columns'>{{row[column.field]}}</td>" +
...
var tableControllerFunction = function (scope, $mdDialog, $uibModal) {
...
angular.module('schemaForm').directive('tableDirective', function ($mdDialog) {
    return {
        ...
        scope: false,
        // Define a controller, use the function from above, inject the scope
        controller : ['$scope', '$mdDialog', '$uibModal', tableControllerFunction],
        // Use the link function to initiate the ngModel in the controller scope
        link: function (scope, iElement, iAttrs, ngModelCtrl) {
            //scope.ngModel = ngModelCtrl;
            //var unregister = scope.$watch(function () {                 
