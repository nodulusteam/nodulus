...
(function($) {
    ...
    BootstrapDialog.TYPE_DEFAULT = 'panel-default';
    BootstrapDialog.TYPE_INFO = 'panel-info';
    BootstrapDialog.TYPE_PRIMARY = 'panel-primary';
    BootstrapDialog.TYPE_SUCCESS = 'panel-success';
    BootstrapDialog.TYPE_WARNING = 'panel-warning';
    BootstrapDialog.TYPE_DANGER = 'panel-danger';
    ...
    BootstrapDialog.SIZE_MEDIUM = 'size-medium';
    BootstrapDialog.SIZE_FULL = 'size-full';
    
    BootstrapDialog.BUTTON_SIZES = {};
    BootstrapDialog.BUTTON_SIZES[BootstrapDialog.SIZE_NORMAL] = '';
    BootstrapDialog.BUTTON_SIZES[BootstrapDialog.SIZE_LARGE] = '';
    BootstrapDialog.BUTTON_SIZES[BootstrapDialog.SIZE_MEDIUM] = '';
    BootstrapDialog.BUTTON_SIZES[BootstrapDialog.SIZE_FULL] = '';
    ...
    BootstrapDialog.prototype = {
        ...
        createModalDialog: function () {
            ...
            if (this.options.height !== undefined) {
                ...
                return $('<div class="modal-dialog" style="height:' + h + 'px;"></div>');
            } else {
        ...
        createModalContent: function () {
            ...
            return $('<div class="modal-content"></div>').addClass(this.getType());
        },
        ...
        createModalHeader: function() {
            return $('<div class="modal-header panel-heading"></div>');
        },
        ...
        createModalBody: function () {
            ...
            return $('<div class="modal-body panel-body"></div>').css("max-height", h).css("overflow", "auto");
        },
        ...
        createButton: function(button) {
            ...
            $button.click(function () {
                $button.append($('<i class="marg fa glyphicon glyphicon-refresh fa-spin"></i>'));
            })
