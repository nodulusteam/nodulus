...
/**
            ...
            return {
                ...
                controller: ['$scope', function ($scope) {
                                    ...
                                    ensureDefault($scope.options.injectClasses, "iExpanded", "fa fa-minus-square-o");
                                    ensureDefault($scope.options.injectClasses, "iCollapsed", "fa fa-plus-square-o");
                                    ensureDefault($scope.options.injectClasses, "iLeaf", "fa fa-square-o");
                                    ...
                                    //tree template
                                    var template =
 '<ul ' + classIfDefined($scope.options.injectClasses.ul, true) + ' id="MyTreeControl">' +
                            ...
                            '<i class="tree-label ' + classIfDefined($scope.options.injectClasses.label, false) + '" ng-class="selectedClass()" ng-click="selectNodeLabel(node)" tree-transclude></i>' +
            ...
            if (scope.onRightClick) {
                ...
                element.bind('contextmenu', function (event) {
                    ...
                    scope.$apply(function () {
                        ...
                        scope.onRightClick({ event: event, node: activeNode.node });
