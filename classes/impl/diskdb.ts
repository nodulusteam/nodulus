...
var Dal = (function () {
    ...
    function _connect(callback) {
        ...
        var diskdb = require('../diskdb/diskdb.js');
        if (!Dal.db || Dal.db === null) {
            var db = diskdb.connect(config.appSettings().database.diskdb.host);
            Dal.db = db;
            ...
            db.collection = function (collectionname) {
                ...
                {
                    this[collectionname].limit = function () {
                        return this;
                    }

                    this[collectionname].each = function (callback) {
